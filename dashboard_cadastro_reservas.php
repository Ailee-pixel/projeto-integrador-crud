...
<html lang="pt-br">
    ...
    <body class="sb-nav-fixed">
        ...
        <h1 class="mt-4">Cadastro de Reservas</h1>          
        <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            Nome Do Cliente:<input type="text" class="form-control" id="nome_cliente" name ="nome_cliente"></label>
            <br>
            <label for="e-mail">E-Mail:
            <input type="text"  class="form-control" id="email_cliente" name ="email_cliente"></label>
            <br>
            <div class=>
            <label  for="telefone">Telefone</label>
            <input type="text" id = "telefone" class="form-control" maxlength="14" size="14" id="telefone_cliente" name ="telefone_cliente" data-mask="(00) 00000-0000" data-mask-selectonfocus="true"></label>
            </div>
            <br>
            <label for="preco">Data da Reserva:</label>
            <input type="datetime-local" class="form-control" id="data_reserva" min="2022-01-01T018:30" max="2023-01-01T23:00" name ="data_reserva" required>
            <br>
            <label for="precaucoes">Quantidade de Pessoas:
            <input type="number" min="1" class="form-control" id="quantidade_pessoas" max="2" size="2" name ="quantidade_pessoas" required></label>
            <br>
            <div>
