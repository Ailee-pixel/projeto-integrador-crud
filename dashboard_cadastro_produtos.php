...
<html lang="pt-br">
    ...
    <body class="sb-nav-fixed">
        ...
        <div class="card-body">
            ...
            <form class="row gx-3 gy-2 align-items-center" action="func_inserir_produtos.php" method="POST">
            <label for="nome do produto">
            Nome Do Produto:<input type="text" class="form-control" id="nome_produto" name ="nome_produto"></label>
            <br>
            <label for="ingredientes">ingredientes:
            <input type="text"  class="form-control" id="ingredientes" name ="ingredientes"></label>
            <br>
            <div class=>
            ...
            <input type="text" class="form-control" id="volume_produto" name ="volume_produto" required></label>
            <br>
            <label for="preco">Preço:
            <input type="text" class="form-control" id="valor_produto"  name ="valor_produto" required></label>
            <br>
            <label for="precaucoes">Precauções:
            <input type="text" class="form-control" id="precaucoes" name ="precaucoes" required></label>
            <br>
            ...
            <br>
             ...
             <a href= "dashboard_consulta_produtos.php" class = "btn btn-outline-danger">Voltar</a>
            </form>
