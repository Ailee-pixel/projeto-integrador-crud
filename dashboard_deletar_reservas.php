...
<html lang="pt-br">
    ...
    <body class="sb-nav-fixed">
        ...
        <h1 class="mt-4">Deletar Reserva</h1>          
        <div class="card mb-4">
        ...
        <div class="card-body">
        <form action="func_deletar_reservas.php" method="POST">

        <h4>Deseja excluir a reserva de "<?php echo $nome?>" do sistema?</h4>
        <br>
        <br>
        <input type="hidden" name="id" value="<?php echo $id?>">
        <input type="checkbox" required>Confirmar a minha decisão
        <br>
        <br>
        <input class = "btn btn-danger" type = "submit" value="Deletar">
        <a class="btn btn-success" href = "dashboard_consulta_reservas.php">Cancelar</a>
